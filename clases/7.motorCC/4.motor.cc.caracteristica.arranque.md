...
# El Modelo: Motor con Excitación en Derivación (Shunt) 
...
### Dinámica del Arranque: Rotor Bloqueado vs. Movimiento 
...
<img src="img/22.caracteristicas4.png" alt="Caracteristicas Motor CC" style="width: 50%; display: block; margin: auto;" />

### Análisis del Gráfico "Dientes de Sierra" (Paso a Paso)
<img src="img/23.caracteristicas5.png" alt="Caracteristicas Motor CC" style="width: 80%; display: block; margin: auto;" />
...
* **Análisis:** En un motor CC Shunt (derivación), la tensión de alimentación es constante, por lo que el Flujo ($\Phi$) es constante. Esto significa que la cupla motora es directamente proporcional a la corriente.


<img src="img/24.caracteristicas6.png" alt="Caracteristicas Motor CC" style="width: 80%; display: block; margin: auto;" /> 
...
## Control de Velocidad: Método 1 (Debilitamiento de Campo) 
...
$$ I_{exc} = \frac{V}{R_{exc} + R_c}$$
3.  **Efecto Magnético:** Menos corriente genera menos Flujo magnético ($\Phi \downarrow$).
4.  **Resultado Mecánico:** Mirando la fórmula de velocidad: **Si el flujo baja, la velocidad SUBE.**

$$ n = \frac{V - 2Ue -I_i \cdot R_i}{K_1 \cdot \Phi} \space \rightarrow  \space n \propto \frac{1}{\Phi}$$

### Características del Método
* **Gráfico:** Las rectas de velocidad se desplazan hacia arriba de forma paralela.

<img src="img/25.caracteristicas7.png" alt="Caracteristicas Motor CC" style="width: 80%; display: block; margin: auto;" />
...
## Control de Velocidad: Método 2 (Resistencia de Armadura) 
...
$$ n = \frac{V -I_i \cdot (R_i + R_A)}{K_1 \cdot \Phi} $$
...
<img src="img/26.caracteristicas8.png" alt="Caracteristicas Motor CC" style="width: 80%; display: block; margin: auto;" />
...
# El Motor con Excitación en Serie
**Concepto Circuital:**
...
<img src="img/27.caracteristicas9.png" alt="Caracteristicas Motor CC" style="width: 50%; display: block; margin: auto;" />
...
* **Gráfico (izquierda):** Es una parábola perfecta
<img src="img/28.caracteristicas10.png" alt="Caracteristicas Motor CC" style="width: 80%; display: block; margin: auto;" />
...
<img src="img/29.caracteristicas11.png" alt="Caracteristicas Motor CC" style="width: 60%; display: block; margin: auto;" />


**Funcionamiento:**
$$Flujo_{Total} = Flujo_{Shunt} \pm Flujo_{Serie}$$

* **Característica (Ver Gráficos ):**
    ...
    * **En Carga:** El bobinado Serie aporta fuerza extra, dando más torque que un Shunt normal, pero sin ser tan agresivo como el Serie puro.
    ...
    <img src="img/30.caracteristicas12.png" alt="Caracteristicas Motor CC" style="width: 80%; display: block; margin: auto;" />
...
## Deducción  de la formula de la cupla motora
Demostramos de dónde sale $C_m = K \cdot \Phi \cdot I$ y la generalización de la misma:

<img src="img/31.caracteristicas13.png" alt="Caracteristicas Motor CC" style="width: 50%; display: block; margin: auto;" />

Partimos de la ley de Lorentz: $F = L \cdot I \cdot B$.
...
3.  **Relación $\Phi$ vs $B$:**
    ...
    *(Nota: Suponemos una distribución uniforme para simplificar).*
...
Aquí vemos "dónde se pierde la energía". Es el **Diagrama de Sankey** del motor.


<img src="img/32.caracteristicas14.png" alt="Caracteristicas Motor CC" style="width: 50%; display: block; margin: auto;" />
...
# El Motor Universal (Motor de "Ambas Corrientes")
...
<img src="img/33.caracteristicas15.png" alt="Caracteristicas Motor CC" style="width: 50%; display: block; margin: auto;" />
...
<img src="img/34.caracteristicas16.png" alt="Caracteristicas Motor CC" style="width: 50%; display: block; margin: auto;" />
